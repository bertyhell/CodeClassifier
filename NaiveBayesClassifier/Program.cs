...
namespace ProbabilityFunctions
{
    public class Program
    {
        static void Main(string[] args)
        {
			...
			table.Columns.Add("=", typeof(double));
			table.Columns.Add("function", typeof(double));

			//training data.
			table.Rows.Add("c++", 0.4, 0.5, 0.1);
			table.Rows.Add("c++", 5.92, 190, 11);
			table.Rows.Add("c++", 5.58, 170, 12);
			table.Rows.Add("c++", 5.92, 165, 10);
